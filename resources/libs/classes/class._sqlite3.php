<?php
	...
	class _sqlite3{
		...
		function _createTable(){
			$definition = isset($GLOBALS['api']['sqlite3']['tables'][$this->table]) ? $GLOBALS['api']['sqlite3']['tables'][$this->table] : false;
			if( !$definition && !empty($this->otable) ){$definition = isset($GLOBALS['api']['sqlite3']['tables'][$this->otable]) ? $GLOBALS['api']['sqlite3']['tables'][$this->otable] : false;}
